...
namespace Circulation
{
    public partial class Form10 : Form
    {
        ...
        public bool canShow;
        public Form10(DBWork.dbReader reader_)
        {
            InitializeComponent();
            this.reader = reader_;
        ...
        private bool FindReaderInOldBase(DBWork.dbReader reader)
        {
        ...
        private void SetChecked(DBWork.dbReader reader)
        {
        ...
        private void InsertComment(string idrold, DBWork.dbReader reader, Notes nts)
        {
        ...
        private int UpdateBooks(string idrold, DBWork.dbReader reader)
        {
