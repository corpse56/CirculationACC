...
namespace Circulation
{
    public partial class Form9 : Form
    {
        ...
        Form1 f1;
        public Form9(DBWork.dbReader reader_,Form1 f1_)
        {
            InitializeComponent();
            f1 = f1_;
            reader = reader_;
        ...
        {
            Form23 f23 = new Form23(this.reader);
            f23.ShowDialog();
            RegInMos();
        }
        ...
        {
            Form24 f24 = new Form24(f1, this.reader);
            if (f24.canshow)
                f24.ShowDialog();
        }
    }
